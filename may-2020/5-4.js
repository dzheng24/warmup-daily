...
const squared = map(numbers, (x => Math.pow(x, 2)));
...
state = {mypeople: people, mystuff: stuff};
...
newState = {...state, mypeople: ['Odie', ...people, 'Garfield'], mystuff: {...stuff, cars: [...stuff.cars, 'Rover']}};
