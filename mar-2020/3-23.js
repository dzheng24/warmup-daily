...
const timeTwo = map(numbers, (x => x * 2));
...
const sixOrBelow = filter(numbers, (x => x <= 6));
...
const sum = reduce(numbers, (total, currentValue) => total += currentValue, 0);
...
console.log(findingRepeat([1,2,1,4,5,2,7,8,9]));